...
export const photos = [
  { id: 1, url: `${food1}`, alttext: "Picture of food number 1" },
  { id: 2, url: `${food2}`, alttext: "Picture of food number 2" },
  { id: 3, url: `${food3}`, alttext: "Picture of food number 3" },
  { id: 4, url: `${food4}`, alttext: "Picture of food number 4" },
  { id: 5, url: `${food5}`, alttext: "Picture of food number 5" },
  { id: 6, url: `${food6}`, alttext: "Picture of food number 6" },
  { id: 7, url: `${food7}`, alttext: "Picture of food number 7" },
  { id: 8, url: `${food8}`, alttext: "Picture of food number 8" },
